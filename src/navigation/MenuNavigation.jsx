        ...
        <Box sx={{ display: 'flex' }}>
            ...
            <AppBar position="fixed" open={open}>
                <Toolbar>
                    ...
                    <Typography variant="h2" noWrap component="div" style={{ fontSize: 20 }}>DASHBOARD
                    </Typography>
            ...
            <Drawer variant="permanent" open={open}>
                <DrawerHeader>
                    <Typography variant="h6" noWrap component="div" sx={{ flexGrow: 1, textAlign: 'center', backgroundColor: 'transparent' }}>
                        <h4><marquee>PAPPU KUSHWAHA</marquee></h4>
                    </Typography>
                    <IconButton onClick={handleDrawerClose} style={{ backgroundColor: 'red' }}>
                    ...
                    {Nav?.map((mainItem, mainIndex) => (
                        <React.Fragment key={mainIndex}>
                            <ListItem
                                ...
                                sx={{
                                    display: 'block',
                                    backgroundColor: mainSelectedItem === mainIndex ? 'green' : 'transparent',
                                    paddingTop: 0,
                                    paddingBottom: 0.3,
                                }}
                                ...
                                >
                                    ...
                                    {mainItem.subList && (
                                        mainSelectedItem === mainIndex ? (
                                            open ? <ExpandMoreIcon sx={{ color: 'red' }} /> : <KeyboardArrowRight sx={{ color: 'white' }} />
                                ...
                                <List sx={{ paddingLeft: 2 }}>
                                    {mainItem?.subList.map((subText, subIndex) => (
                                        <ListItem
                                            ...
                                            sx={{
                                                display: 'block',
                                                backgroundColor: subListSelectedItem === subIndex + 1 ? 'darkblue' : 'transparent',
                                                paddingTop: 0,
                                                paddingBottom: 0,
                                            }}
